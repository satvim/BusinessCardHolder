...
public class ListDevices extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBtAdapter == null) {
            Log.v("Business Carder","Bluetooth not supported in current device");
        }
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<BluetoothDevice>(this, R.layout.activity_device_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<BluetoothDevice>(this, R.layout.activity_device_name);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            BluetoothDevice connectDevice = (BluetoothDevice) av.getAdapter().getItem(arg2);
            ConnectThread connectThread = new ConnectThread(connectDevice);
